...
class MyEnv(gym.Env):
    ...
    def step(self, action):
        ...
        #       Then if we do base conversion, we can transfer Decimal number to Hexadecimal number,
        ...
        if self.accepted:
            ...
            print('current_service done')
            self.add_to_list(current_service)
            print('add to list done')
            self.map_service(current_service)
            print('map service done')
