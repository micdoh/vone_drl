...
class VoneEnv(gym.Env):
    def __init__(
        ...
        self.min_node_cap_request = int(min_node_cap_request)
        self.max_node_cap_request = int(max_node_cap_request)
        self.node_accepted = False
        self.min_slot_request = int(min_slot_request)
        self.max_slot_request = int(max_slot_request)
        self.min_vnet_size = int(min_vnet_size)
        self.max_vnet_size = int(max_vnet_size)
